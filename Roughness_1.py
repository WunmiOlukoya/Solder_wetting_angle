# -*- coding: utf-8 -*-
"""
Created on Mon Jul 31 15:05:52 2023
...
img_cv = cv2.imread('images/picture1.png')
...
fig_inp = ginput(2) # it will wait for two clicks

for iclick in range(2): 
...
print("the contact angle is",180-rot_angle)
print("teh actual angle",rot_angle)
